...
dataset_path <- file.path(proj_path, "tam_chromatin_clusters.Rds")
...
```
# Convert Rds to Anndata 9NIA dataset is huge, subset, then convert
``` {r MuDataSeurat}
MuDataSeurat::WriteH5AD(seurat_obj, file.path(proj_path, "NIA_fibroblasts_CTRL.h5ad"), assay = "RNA")
```
